...
export default function Dashboard({ user, setUser }) {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("https://resume-builder-backend-iceh.onrender.com/api/data/getAllDetailsByEmail", {
  ...
  const deleteDetail = async (e) => {
    console.log(e.name);
    setLoading(true);
    await axios.post("https://resume-builder-backend-iceh.onrender.com/api/data/deleteDetailsByDetailId", { email: user.email, detailId: e });
    setLoading(false);
  ...
  const deleteAccount = async () => {
    setLoading(true);
    await axios.post("https://resume-builder-backend-iceh.onrender.com/api/data/deleteUserAndDetails", { email: user.email });
    setLoading(false);
    handleLogout();
  }
        ...
        <div className="my-[13vh] mx-[12vw] text-[#121417] font-manrope ">
          ...
          {user && 'password' in user && user.password !== null && (
            <form onSubmit={async(e)=>{
              ...
              setLoading(true);
              await axios.post("https://resume-builder-backend-iceh.onrender.com/api/data/updatePasswordFromUsers", { password:newPassword ,email: user.email });
              setLoading(false);
