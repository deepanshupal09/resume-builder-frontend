...
export default function UserInfoEntries({ user }) {
  ...
  useEffect(() => {
    ...
    if (user && detailid) {
      ...
      setLoading(true)
      axios.get("https://resume-builder-backend-iceh.onrender.com/api/data/getDetailsByDetailId", { headers: { email: user.email, detailid: detailid } }).then((result) => {
        setLoading(false)
    ...
    axios
      ...
      .then((res) => {
        ...
        if (result.length > 0) {
          ...
          axios
            .post("https://resume-builder-backend-iceh.onrender.com/api/data/addDetails", body)
            .then((res) => {
              setSaved(true);
    ...
    axios
      ...
      .then((res) => {
        ...
        if (result.length > 0) {
          ...
          axios
            .post(
              "https://resume-builder-backend-iceh.onrender.com/api/data/updateDetailsByDetailId",
              body
            )
            .then((res) => {
              setLoading(false)
